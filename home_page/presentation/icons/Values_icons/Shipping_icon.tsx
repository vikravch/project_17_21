...
function Shipping_icon(props: Props) {
    return (
        ...
        <path d="M20 16H16" stroke={props.color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M20 24H12" stroke={props.color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
    );
}

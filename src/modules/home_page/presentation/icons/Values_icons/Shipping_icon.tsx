...
function Shipping_icon(props: Props) {
    return (
        ...
        <path d="M20 16H16" stroke={props.color} stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M20 24H12" stroke={props.color} stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
    );
}

export default Shipping_icon;